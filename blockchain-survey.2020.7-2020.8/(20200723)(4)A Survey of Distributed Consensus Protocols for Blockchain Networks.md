...
8. 比较所有协议，总结它们的设计哲学/思想
   ...
   2. 给出对上文中介绍的全部共识协议应用 5 组件框架的表格：表 3
   3. 总结设计思想
...
3. 而与第一篇论文的过于拘泥于方法论相比，本文对于方法论的介绍过于简略，其提出的 5 组件框架只用了一个小节及在最后得到一个汇总的表格就草草带过，没有对这个过程做进一步的介绍，显得有些生硬，少了很多说服力，文末最后的范式也缺少了实际操作的示例
