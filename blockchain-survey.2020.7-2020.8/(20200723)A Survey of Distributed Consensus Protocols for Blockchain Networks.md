...
- 根据 5 组件框架对共识协议进行算法抽象化和脆弱性分析，并根据不同的性能指标进行比较
- 根据上述分析和比较，清除在这些共识协议在应用场景、关键假设、预期容错、可扩展性、缺点及其权衡取舍几方面的不同
...
2. 比特币共识细节
   ...
   3. 安全分析，容错能力 50%
   3. 缺陷和威胁：性能与安全的权衡、能源效率低、日蚀攻击、自私挖矿、矿池与中心化风险
4. 改进：介绍了两种对中本聪共识协议的改进
   5. PoW 结合 BFT 的几种协议介绍
